...
export const company: Company = {
  ...
  description:
    "Modern men's lifestyle brand combining fashion and technology — crafted for the ones who own their style.",
  email: "qyverostore@gmail.com",
  whatsappNumber: "201505967144",
  foundedYear: 2026,
};
